...
<body onload="window.print()">
    ...
    <table width="100%" style="border: 0;">
        ...
        <tr>
            <td>{{ $customer->paket->jenis_paket }}</td>
            <td></td>
            <td class="text-right">Rp. {{ $customer->paket->iuran }}</td>
        </tr>
        <tr>
            <td>Instalasi</td>
            <td></td>
            <td class="text-right">Rp. {{ $customer->paket->instalasi }}</td>
        </tr>
        <tr>
            <td>Diskon:</td>
            <td></td>
            <td class="text-right">Rp. {{ $ubahpaket->transaksi->diskon }}</td>
        </tr>
        {{-- @endforeach --}}
    </table>
    <p class="text-center">===================================</p>
    ...
    <table width="100%" style="border: 0;">
        <tr>
            ...
            <td class="text-right">Rp.
                {{ $total_biaya = $ubahpaket->paket->iuran + $ubahpaket->paket->instalasi - $ubahpaket->transaksi->diskon }}
            </td>
        </tr>
        <tr>
            <td>Tunai:</td>
            <td class="text-right">Rp. {{ $ubahpaket->transaksi->bayar }}</td>
        </tr>
        <tr>
            <td>Kembali:</td>
            <td class="text-right">Rp. {{ $ubahpaket->transaksi->bayar - $total_biaya }}</td>
        </tr>
        <tr>
            {{-- <td>Kembali:</td> --}}
            <td></td>
            <td class="text-right"><b>{{ $ubahpaket->transaksi->status }}</b></td>
        </tr>
    </table>
    <p class="text-center">===================================</p>
    <br>
