...
<body onload="window.print()">
    ...
    <table width="100%" style="border: 0;">
        ...
        <tr>
            <td>Diskon:</td>
            <td></td>
            <td class="text-right">Rp. {{ $pemasangan->transaksi->diskon }}</td>
        </tr>
        {{-- @endforeach --}}
    </table>
    <p class="text-center">===================================</p>
    ...
    <table width="100%" style="border: 0;">
        <tr>
            ...
            <td class="text-right">Rp.
                {{ $total_biaya = $pemasangan->paket->iuran + $pemasangan->paket->instalasi - $pemasangan->transaksi->diskon }}
            </td>
        </tr>
        <tr>
            <td>Tunai:</td>
            <td class="text-right">Rp. {{ $pemasangan->transaksi->bayar }}</td>
        </tr>
        <tr>
            <td>Kembali:</td>
            <td class="text-right">Rp. {{ $pemasangan->transaksi->bayar - $total_biaya }}</td>
        </tr>
        <tr>
            {{-- <td>Kembali:</td> --}}
            <td></td>
            <td class="text-right"><b>{{ $pemasangan->transaksi->status }}</b></td>
        </tr>
    </table>
    <p class="text-center">===================================</p>
    <br>
